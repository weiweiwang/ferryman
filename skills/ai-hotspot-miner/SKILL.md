...
3. Formatted article HTML: `reports/<yyyy-mm-dd>/ai-hotspot-article-<article_slug>.html`
...
10. **Article Source Hygiene**: The publishable article Markdown must contain only the final title and article body. All planning notes, evidence notes, candidate titles, and delivery instructions belong in the research brief, not the article file.
