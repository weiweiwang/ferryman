...
## Final Pro Review Pass

Before final handoff, use a higher-capability Pro model, if available, to sanity-check topic strength, claim support, title risk, article cleanliness, matching HTML output, and generated-file links. If no Pro model is available, fall back to the current model.

Do not add review notes to the publishable article.
